...
def main():
    ...
    method = 'exact' # proposed, ori, exact, wcvar, bonferroni. the method to reformulate the WDRJCC
    N_WDR = 150 # the number of scenarios for the WDRJCC
    epsilon = 0.05 # the risk level
    theta = .1 # the Wasserstein radius. Bonferroni approximation requires small theta for feasibility
